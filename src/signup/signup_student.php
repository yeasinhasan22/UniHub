    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST"){
        ...
        if(empty($errors)){
            ...
            $statement=$conn->prepare("INSERT INTO 
                                    student (firstname,lastname,university_name,student_id,user_id,email,dept,gender) 
                                    VALUES 
                                    (:firstname,:lastname,:university,:student_id,:user_id,:email,:dept,:gender)");
...
<body>
    ...
    <div class='container border border-primary'>
        ...
        <p class="link">Have an account? <a href="../login/login_student.php">Sign In</a></p>
    </div>
